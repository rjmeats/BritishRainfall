...
The *TYRain_1840-1849_E_pt1.pdf* file in the Met Office archive has several sheets which relate to locations in Derbyshire and Cheshire that are also present in the later MS&LR sheets, but none of them are explicitly labelled with 'MS&LR'. The records in the sheets are usually intermittent, with many of them concentrating on 1847 and years just before then.
...
This [web site](https://canalrivertrust.org.uk/enjoy-the-waterways/canal-and-river-network/ashton-canal) has a useful map of the area relevant to the 1848 Report.

Rain gauge measurements formed the basis of some of Homersham's arguments, with the some of the rain gauge data presented in the report matching well to some of the sheets in the Met Office 1840s archive, often at locations that MS&LR went on to make measurements at or near for decades to come.

The report document ends with a copy of a paper presented by Somersham to the Royal Society on May 25th 1948, which discusses the impact of altitude on rainfall, as evidenced by rain gauge data from the MS&LR reservoirs and their surrounding hills.

*In the end, it seems that MS&LR's report did not persuade Manchester Corporation to change its mind - the [Longdendale Chain](https://en.wikipedia.org/wiki/Longdendale_Chain) Reservoirs were built from the late 1840s onwards, and some remain in use.*
...
* page 125 (p8 of the Royal Society paper) shows rainfall figures from three MS&LR reservoirs and nearby hills, again to illustrate effect of altitude
...
The rain gauges found in the Report are presented in the tables below. The 'Possible Sheet' field indicates a rainfall sheet (as page number in the TYRain_1840-1849_E_pt1 volume PDF file) in the Met Office Archive which looks a reasonable match to this rain gauge's data.

Sites associated with MS&LR:

|Site|Altitude (ft)|Dates|Data from|Possible Sheet|
|----|--------|---------|-----|-----|
...
|Todd's Brook, Brinks*|1500|1847|J.Meadows|-|
...
* Todd's Brook, Brinks seems to refer to Brinks Farm on Sponds Hill, grid reference SJ968793, in which case the height is more like 1200ft than the quoted 1500ft. Possibly the report has confused this 'Brinks' with 'Woodhead Brinks Edge' (p26 of TYRain_1840-1849_E_pt1, height 1500ft written on the sheet). If so, then Todd's Brook, Brinks is likely to be the site called 'Bollington Sponds Hill' in the MS&LR sheets.
...
|Woodhead Brinks Edge|p26|
|Fairfield|p41|

Sites not associated with MS&LR:
...
In relation to the 11 MS&LR-related rain gauges in the 1848 report:
* the rainfall sheets for 7 of them have been located in the Met Office 1840s archive (in the TYRain_1840-1849_E_pt1 volume)
* most of the 11 are in locations that have MS&LR rain gauges for the 1850s+
...
So I don't think there's a strong need to explicitly link the 1840s MS&LR gauges into to 1850s+ sequences; they may not be fully continuous with the 1850s gauges.
...
|Woodhead Brinks Edge|1500|p26|1847|-|-|
...
|Todd's Brook, Brinks [ = Bollington Sponds Hill ? ]|1500 [1200-1300 ?]|1847|Y|-|
