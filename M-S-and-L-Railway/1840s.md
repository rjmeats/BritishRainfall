...
|Site|Altitude (ft)|Dates|Data from|Possible Sheet|
|----|--------|---------|-----|-----|
|Belmont Spring water reservoir, Sharples|850|1843-47|J.Magnall|
...
In addition, the 1848 report implies there were rainfall readings for the following MS&LR-related locations, which have been located in the Met Office archive:

|Site|Altitude (ft)|Dates on sheet|Figures used in 1848 Report ?|1840 Figures used in L&P Memoirs ?|
|----|----|----|----|----|
|Newton Station|350|1847|Y|-|
|Todd's Brook, Brinks|1500|1847|Y|-|
